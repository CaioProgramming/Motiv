...
fun blurView(context: Context, blurView: Int) {
    if (context is Activity) {
        val blur: RealtimeBlurView? = context.findViewById(blurView)
...
fun unblurView(context: Context, blurView: Int) {
    if (context is Activity) {
        val blur: RealtimeBlurView? = context.findViewById(blurView)
        blur?.gone()
    } else {
...
fun snackmessage(context: Context, message: String, backcolor: Int = Color.BLACK, textColor: Int = Color.WHITE, parentContainer: Int) {
    if (context is Activity) {
        val contextView = context.findViewById<View>(parentContainer)
